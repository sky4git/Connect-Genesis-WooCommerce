...
class Plugin_Name {
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Plugin_Name_Admin( $this->get_genesis_woocoomerce(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Plugin_Name_Public( $this->get_genesis_woocoomerce(), $this->get_version() );
