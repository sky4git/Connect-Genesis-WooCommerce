<<<<<<< HEAD
=== Woocoomerce With Genesis Theme ===
...
>>>>>>> 8ea81e2a3d941f29a769a82dfc0bdaf1d96cd618
Stable tag: 1.0
...
== Installation ==
1. Upload `connect-genesis-woocoomerce` directory to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
